...
EOF_2
  echo "\"file:${PWD}/${dirname}/output/step3_inDQM_${p_or_np}_${linenum_tot}_${linenum}.root\"" >> ${dirname}/mtdValidation_muon_cfg_${p_or_np}_${linenum_tot}_${linenum}.py
...
EOF_3
  echo "fileName=cms.string(\"file:${PWD}/${dirname}/output/ntuple_${p_or_np}_${linenum_tot}_${linenum}.root\"))" >> ${dirname}/mtdValidation_muon_cfg_${p_or_np}_${linenum_tot}_${linenum}.py

  cat << "EOF_4" >> ${dirname}/mtdValidation_muon_cfg_${p_or_np}_${linenum_tot}_${linenum}.py
